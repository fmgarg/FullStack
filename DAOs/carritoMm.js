...
const carritoMm = express.Router ()
...
carritoMm.delete ('/:cartId', async (req, res)=>{
...
carritoMm.get ('/:cartId/productos', async (req, res)=>{
    userId = JSON.parse(req.params.cartId)
    //console.log(number)
...
carritoMm.delete ("/:cartId/productos/:prodId", async (req, res)=>{
    cartId = JSON.parse(req.params.cartId)
